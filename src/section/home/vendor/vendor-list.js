...
const VendorList = () => {
    ...
    const getData = () => {
        DataService.getUser('vendor').then((data) => {
    ...
    return (
        <div className="row">
            ...
            <div className="row mb-4">
                ...
                <h4 className="f-700 mb-4">Vendor</h4>
                </div>
                <div className="col-sm-6 d-flex justify-content-end">
                <Link to={"/add-vendor"} className="btn btn-secondary">Add Vendor</Link>
                </div>
            </div>
                ...
                <div className="table-header d-flex align-items-center">
                    <div className="table-search">
                        ...
                        <input type="search" onChange={onChangeSearch} name="search" placeholder="Search vendor" />
                    </div>
