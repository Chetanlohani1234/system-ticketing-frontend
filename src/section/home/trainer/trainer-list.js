...
const TrainerList = () => {
  ...
  const getData = () => {
    if(storedUserId){
      DataService.getArtist(storedUserId).then((data) => {
  ...
  const deletetrainer = (item) => {
    setLoading(true);
    DataService.deleteArtist(item?._id).then(
      () => {
      ...
      <div className="col-md-12">
        <div className="row mb-4">
          <div className="col-sm-6">
            <h4 className="f-700 mb-4">All Artist</h4>
          </div>
          <div className="col-sm-6 d-flex justify-content-end">
            <Link to={"/add-artist"} className="btn btn-secondary">
              Add Artist
            </Link>
          </div>
        </div>
                    ...
                    <td className="d-flex align-items-center">
                      {/* {item?.images[0]?.path ? (
                        <span className="thumb-img me-2">
                          <img
                            src={
                              "https://https://opm-stream.onrender.com/" +
                              item?.images[0]?.path
                            }
                            className="Camp-img"
                            alt="Camp"
