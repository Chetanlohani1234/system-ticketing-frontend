...
const BecomeVendorContent = () => {
    ...
    const getData = () => {
        DataService.getPage('becomevednor').then((data) => {
    ...
    const handleSubmit = (e) => {
        ...
        if(pageId){
            ...
            data.append('page_type','becomevednor');
        ...
        <div className="container-fluid">
            ...
            <div className="row">
                <div className="d-flex w-100 justify-content-between align-items-center mb-4">
                    <h4 className="mb-0 f-700">Become a Vendor</h4>
...
export default BecomeVendorContent;