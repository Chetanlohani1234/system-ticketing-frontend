        ...
        <div className="container-fluid">
            ...
            <div className="row">
                <div className="d-flex w-100 justify-content-between align-items-center mb-4">
                    <h4 className="mb-0 f-700">Edit Brand</h4>
                            ...
                            <div className="card-body p-4">
                               <div className="mb-4">
                                ...
                                <div className="mb-4">
                                    ...
                                    <select value={category_ids} style={{height:'200px'}} required className="form-select" multiple onChange={handleChangeCategory}>
...
export default EditBrandDetail;