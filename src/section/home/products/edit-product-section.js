...
const EditProductSection = () => {
  ...
  const getProduct = async (categoryData) => {
    await DataService.getProductDetail(params.id)
      .then((data) => {
        ...
        setdeliveryTime(productData?.expectedDeliveryTime);
        setBrand(productData?.brand_id);
        setGroup(productData?.serviceAbilityGroup);
        setDescription(productData?.description);
        setSku(productData?.SKU_Number);
        ...
        setSelectValue(productData?.howToGet);
  ...
  const handleSubmit = (e) => {
    ...
    data.append(
      "variant",
      inputFields.length > 0 ? JSON.stringify(inputFields) : ""
    );
    data.append(
      "variations",
      inputVariations.length > 0 ? JSON.stringify(inputVariations) : ""
    );
    if (masterCategoryId) {
    ...
    DataService.updateProduct(params.id, data).then(
              ...
              <div className="card">
                <div className="card-body text=center">
                  ...
                  <div className="mb-3">
                    ...
                    <select
                      required
                      defaultValue={product?.master_category_id}
                            ...
                            <div className="row">
                              <div className="mb-3 col-md-6">
                                ...
                                <input
                                  ...
                                  value={data?.variant}
                                  onChange={(evnt) =>
                                    handleVariantChange(index, evnt)
                                  }
                                  className="form-control"
                                  placeholder="Title"
                                />
