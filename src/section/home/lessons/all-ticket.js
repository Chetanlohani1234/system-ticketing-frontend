                        ...
                        {data && data.length > 0
                            ? data.map((item, i) => (
                                <tr>
                                    ...
                                    <td>
                                        <img src={item.image.url} style={{width:'100px',height:'50px'}}/>
                                    </td>
                                    <td>{item.heading}</td>
                                    <td>{item.priority}</td>
                                    <td>{item.category}</td>
                                    ...
                                    <Link to={"/edit-ticket/" + item._id} className="mx-2"><svg width="17" height="12" viewBox="0 0 17 12" fill="none" xmlns="http://www.w3.org/2000/svg">
