...
const CustomerList = () => {
    ...
    const getData = () => {
        DataService.getUser('user').then((data) => {
    ...
    const onChangeSearch =(e)=>{
        if(e.target.value){
            const result = data.filter(value=>{
                return value.user_name.toLowerCase().includes(e.target.value.toLowerCase()) || 
      ...
      const deleteVendor  = (item) =>{
        ...
        DataService.updateCustomerDetail(item?.id, data).then(
            () => {
                toast.success('This Customer is inactive now!!', {
    ...
    return (
        <div className="row">
            ...
            <div className="col-md-12">
                <h4 className="f-700 mb-4">Customer</h4>
                <div className="table-header d-flex align-items-center">
                    <div className="table-search">
                        ...
                        <input type="search" onChange={onChangeSearch} name="search" placeholder="Search customer" />
                    </div>
                    ...
                    <label className="me-3">Status</label>
                        ...
                        <Link to={"/add-customer"} className="btn btn-secondary">Add Customer</Link>
                ...
                <table class="table table-striped">
                    ...
                    {filteredData && filteredData.length > 0
                        ...
                        <tr>
                            ...
                            {(item.file_path ? 
                                <span className="thumb-img me-2"><img src={"opm-stream.onrender.com/"+item.file_path} className="product-img" alt="customer" /></span>
                            ...
                            <td><span className="d-flex justify-content-end"><Link to={"/view-customer/"+item.id}  className="mx-2"><svg width="17" height="12" viewBox="0 0 17 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Link to={"/edit-customer/"+item.id} className="mx-2"><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body py-5">
                                                        ...
                                                        <h5 className="mt-4">Are you sure you want to inactive this customer?</h5>
