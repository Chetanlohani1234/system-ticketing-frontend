    ...
    return (
        <div className="row">
            <div className="col-md-12">
                <h4 className="f-700 mb-4">All Master Categories</h4>
                <div className="table-header d-flex align-items-center">
                    ...
                    <label className="me-3">Status</label>
                        ...
                        <Link to={"/add-master-categories"} className="btn btn-secondary">Add Master Category</Link>
                        ...
                        ? filteredData.map((item, i) => (
                            <SortableItem key={i}  items={filteredData}  onSortItems={onSortItems} sortId={i}>
                                    ...
                                    <td><span className="d-flex justify-content-end">
                                      {/* <Link to={"/view-master-category-detail/"+item._id} href="#" className="mx-2"><svg width="17" height="12" viewBox="0 0 17 12" fill="none" xmlns="http://www.w3.org/2000/svg">
