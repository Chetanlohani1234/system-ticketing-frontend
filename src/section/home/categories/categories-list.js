    ...
    return (
        <div className="row">
            <div className="col-md-12">
                <h4 className="f-700 mb-4">All Categories</h4>
                <div className="table-header d-flex align-items-center">
                    ...
                    <label className="me-3">Status</label>
                        ...
                        <Link to={"/add-categories"} className="btn btn-secondary">Add Category</Link>
                ...
                <table class="table table-striped">
                    ...
                    {filteredData && filteredData.length > 0
                        ...
                        <tr>
                            ...
                            <td><span className="d-flex justify-content-end"><Link to={"/view-category-detail/"+item._id} href="#" className="mx-2"><svg width="17" height="12" viewBox="0 0 17 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <Link to={"/edit-category-detail/"+item._id} className="mx-2"><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
