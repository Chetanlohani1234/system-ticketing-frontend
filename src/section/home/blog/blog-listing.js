...
const BlogList = () => {
    ...
    const deleteBlog  = (item) =>{
        setLoading(true);
        DataService.deleteBlog(item?.id).then(
            () => {
    ...
    return (
        <div className="row m-0">
            ...
            <div className="col-md-12">
                <h4 className="f-700 mb-4">Blog</h4>
                        ...
                        ? data.map((item, i) => (
                            <div className="col-xl-4 col-md-6 col-12 mb-3">
                                <div className="blogList bg-grey">
                                    <div className="blogImage"><img src={item.file_path  ? "opm-stream.onrender.com/"+item.file_path : ""} className="w-100" alt="blogimage" /></div>
                                    <div className="caption">
                                        <h5>{item.name.length > 20 ? item.name.substring(0,20) + "..." : item.name}</h5>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body py-5">
                                                        ...
                                                        <h5 className="mt-4">Are you sure you want to delete this blog?</h5>
                                                        <div className="d-flex justify-content-center mt-3">
                                                        <button type="button" class="btn btn-default me-3" data-bs-dismiss="modal">No</button>
                                                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onClick={() => {deleteBlog(item) } }>Yes</button>
                                                        </div>
                                                        </div>
                                                    </div>
