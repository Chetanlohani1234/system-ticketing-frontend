...
const AllLessons = () => {
    ...
    const getData = () => {
        if(storedUserId){
            DataService.getEvent(storedUserId).then((data) => {
    ...
    const deleteLesson  = (item) =>{
        setLoading(true);
        DataService.deleteEvent(item?._id).then(
            () => {
    ...
    return (
        <div className="row">
            ...
            <div className="col-md-12">
                <h4 className="f-700 mb-4">All Events</h4>
                {message && (
                ...
                <div className="table-header d-flex align-items-center">
                    <div className="table-search">
                        ...
                        <input type="search" onChange={onChangeSearch} name="search" placeholder="Search Event" /> */}
                    </div>
                    ...
                    <form class="d-flex align-items-center ms-auto">
                        ...
                        <Link to={"/add-event"} className="btn btn-secondary">Add Event</Link>
                            ...
                            ? filteredData.map((item, i) => (
                                <tr>
                                    ...
                                    <td className="d-flex align-items-center">
                                        {(item.file_path ?
                                            <span className="thumb-img me-2"><img src={"opm-stream.onrender.com/" + item.file_path} className="lesson-img" alt="lesson" /></span>
                                            : ""  
                                        )}{item.title}
                                    </td>
                                    <td>{item.location}</td>
                                    ...
                                    <td width="150"><span className="d-flex justify-content-end">
                                        ...
                                        <Link to={"/edit-event/" + item._id} className="mx-2"><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body py-5">
                                                        ...
                                                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onClick={() => {deleteLesson(item) } }>Yes</button>
                                                        </div>
                                                        </div>
                                                    </div>
