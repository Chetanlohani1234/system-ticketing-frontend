...
const FaqList = () => {
    ...
    const getCategory = () => {
        DataService.getAllFaq().then((data) => {
    ...
    const onChangeSearch =(e)=>{
        if(e.target.value){
            const result = faq.filter(value=>{
                return value.question.toLowerCase().includes(e.target.value.toLowerCase()) || 
    ...
    const deleteFaq  = (item) =>{
        ...
        setLoading(true);
        DataService.updateFaq(data, item?.id).then(
            () => {
    ...
    return (
        <div className="row">
            <div className="col-md-12">
                <h4 className="f-700 mb-4">Faq's</h4>
                <div className="table-header d-flex align-items-center">
                    <div className="table-search">
                        ...
                        <input type="search" onChange={onChangeSearch} name="search" placeholder="Search Faq's" />
                    </div>
                    <form class="d-flex align-items-center ms-auto">
                        <Link to={"/add-faq"} className="btn btn-secondary">Add New</Link>
                    </form>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <span className="d-flex justify-content-end">
                                    <Link to={"/faq-details/"+item.id}  className="mx-2">
                                    ...
                                    <Link to={"/edit-faq/"+item.id} className="mx-2">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body py-5">
                                                        ...
                                                        <h5 className="mt-4">Are you sure you want to delete this Faq?</h5>
                                                        <div className="d-flex justify-content-center mt-3">
                                                        <button type="button" class="btn btn-default me-3" data-bs-dismiss="modal">No</button>
                                                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onClick={() => {deleteFaq(item) } }>Yes</button>
                                                        </div>
                                                        </div>
                                                    </div>
